...
const PHASES = [
  ...
  { id: 8, title: 'AI Estate Sale Company Owner & Autonomous Agents', status: 'DONE', notes: 'AdminAI Estate Sale Company Owner, autonomous run engine, AI coach, AI credits system, Estate Sale Company Owner AI usage alerts.' },
...
const MISSING_ITEMS = [
  ...
  'ProviderDirectory has no records — Estate Sale Company Owners, probate realtors, cleanout vendors, and investors must be added and assigned to NJ counties (Monmouth, Ocean, Middlesex) to activate provider-match CTAs on all life event pages.',
  'TerritoryLaunch has no NJ territory record — no Estate Sale Company Owner, agent, cleanout vendor, or investor assigned to any NJ county.',
