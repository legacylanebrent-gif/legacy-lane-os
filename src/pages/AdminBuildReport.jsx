...
const PHASES = [
  { id: 1, title: 'Core Platform & Estate Sales', status: 'DONE', notes: 'EstateSale entity, operator dashboard, sale listings, early sign-in, checkout, scan & cart, settlement statement.' },
  ...
  { id: 5, title: 'Operator Growth & Referral Engine', status: 'DONE', notes: 'Referral agreements, wallet, commissions, agent partnerships, operator territory profiles, Houszu integration.' },
  { id: 6, title: 'Marketing & Campaigns', status: 'DONE', notes: 'Social ads hub, Customer.io integration, operator marketing dashboard, Facebook ad campaigns, campaign builder.' },
  { id: 7, title: 'Territory & Agent Network', status: 'DONE', notes: 'Territory heatmap, Houszu territory API, agent dashboard, operator portal, territory FB post generator.' },
  { id: 8, title: 'AI Operator & Autonomous Agents', status: 'DONE', notes: 'AdminAI operator, autonomous run engine, AI coach, AI credits system, operator AI usage alerts.' },
...
const ADMIN_DASHBOARDS = [
  ...
  { name: 'AdminAIOperator', label: 'AI Operator Console', status: 'DONE' },
...
const AUTOMATIONS_LIST = [
  ...
  { name: 'Weekly Operator SEO Digest Email', type: 'Scheduled Weekly Mon 8am', status: 'DONE', lastRun: 'Success' },
  { name: 'Nightly Search Console Data Fetch', type: 'Scheduled Daily 1am', status: 'DONE', lastRun: 'Success' },
  { name: 'Nightly Operator SEO Authority Profile', type: 'Scheduled Daily 3am', status: 'DONE', lastRun: 'Success' },
...
const MISSING_ITEMS = [
  ...
  'ProviderDirectory has no records — estate sale operators, probate realtors, cleanout vendors, and investors must be added and assigned to NJ counties (Monmouth, Ocean, Middlesex) to activate provider-match CTAs on all life event pages.',
