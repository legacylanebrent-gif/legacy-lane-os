...
const preferredFeatures = [
  ...
  'Small monthly per city or micro-territory participation fee of $27 / month (discount for multiple cities)',
  'Receive qualified seller & referral opportunities',
  'Build relationships with local estate sale companies',
  '25% referral fee only when a platform-generated or estate sale company lead deal closes',
        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="bg-white border border-slate-200 rounded-xl p-8 text-left shadow-sm">
            <p className="text-slate-700 text-lg leading-relaxed mb-4">
              All referral money and transactions flow through a real estate brokerage as per normal. The estate sale company also receives a portion in <strong className="text-slate-900">marketing credits via EstateSalen</strong> to be applied toward future leads and services on EstateSalen.com.
            </p>
            ...
            <div className="space-y-8">
              ...
              <div className="flex gap-6 items-start">
                ...
                <div className="bg-orange-50 border border-orange-200 rounded-2xl p-6 flex-1">
                  ...
                  <p className="text-slate-600 leading-relaxed">
                    EstateSalen.com runs paid advertising, SEO campaigns, and outreach that bring in homeowners and executors dealing with probate, downsizing, inherited homes, senior moves, and other life transitions. These are real people who need real help — and they reach out to us first.
                  </p>
                </div>
              </div>
