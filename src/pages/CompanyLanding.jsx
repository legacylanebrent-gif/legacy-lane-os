...
const BUSINESS_FEATURES = [
  ...
  { icon: Camera, title: 'AI Item Pricing', desc: 'Google Lens-powered pricing tool instantly estimates market value for any item you photograph.' },
  { icon: Bot, title: 'AI Content Generator', desc: 'Generate Facebook posts, Instagram captions, email blasts, SMS, and blog posts in seconds.' },
