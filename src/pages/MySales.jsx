                    ...
                    {(() => {
                      ...
                      return (
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-2">
                          ...
                          {!isCompleted && (<Button variant="outline" size="sm" asChild className="w-full border-green-500 text-black hover:bg-green-50"><Link to={createPageUrl('ScanAndCart') + '?saleId=' + sale.id}><DollarSign className="w-3 h-3 mr-1" />POS</Link></Button>)}
                          {!isCompleted && (<Button variant="outline" size="sm" asChild className="w-full border-teal-500 text-black hover:bg-teal-50"><Link to={createPageUrl('Worksheet') + '?saleId=' + sale.id}><FileText className="w-3 h-3 mr-1" />Worksheet</Link></Button>)}
