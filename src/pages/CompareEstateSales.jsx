...
const CATEGORIES = [
  ...
  {
    label: 'Online Selling & Marketplace + AI and Google Lens Pricing Automation',
    rows: [
  ...
  },
  {
    ...
    rows: [
      ...
      { feature: 'Mileage Tracker', us: true, them: false },
      { feature: 'Receipt Scanner adds to Expenses', us: true, them: false },
  ...
  },
  {
    ...
    rows: [
      ...
      { feature: 'Save & bookmark favorite sales', us: true, them: false },
      { feature: 'Follow companies — never miss their sales', us: true, them: false },
      { feature: 'Push notifications for saved sale reminders', us: true, them: false },
      { feature: 'Wanted items hunt list (ISO matching)', us: true, them: false },
      { feature: 'Price drop alerts on watched items', us: true, them: false },
      { feature: 'Browse by item type across ALL sales', us: true, them: false },
      { feature: 'Category & brand-based sale browsing', us: true, them: false },
      { feature: 'See what similar items sold for (price history)', us: true, them: false },
      ...
      { feature: 'QR code check-in for rewards at every sale', us: true, them: false },
      ...
      <section className="bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 text-white py-16 md:py-24">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 text-center">
          ...
          <p className="text-lg text-slate-300 max-w-2xl mx-auto mb-10 leading-relaxed">
            EstateSales.net is a weekend sale listing directory. And quite honestly it was the best in the industry ... but the industry needed more! So we created it for our own business and it birthed EstateSalen.com. Our platform is all that EstateSales.net is plus a full business operating system with 115+ tools built for estate sale professionals to make you more efficient, benefit from FREE leads daily, manage your entire business and offer training to employees to possibly grow teams to expand your business. See every difference, side by side in the tables below.
          </p>
