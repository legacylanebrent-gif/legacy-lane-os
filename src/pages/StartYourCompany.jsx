...
export default function StartYourCompany() {
  ...
  const benefits = [
    ...
    },
    {
      ...
      description: 'Comprehensive onboarding and ongoing mentorship from successful Estate Sale Company Owners'
    },
    {
      icon: Zap,
  ...
  const included = [
    ...
    'Community of successful Estate Sale Company Owners',
