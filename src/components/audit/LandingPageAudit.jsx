...
const DEFAULT_PAGES = [
  { page_name: 'Operator Claim Page', page_url: '/claim-business', page_status: 'Built', form_connected: true, thank_you_page_exists: false, crm_capture_exists: true, operator_notification_exists: true, email_notification_exists: true, retargeting_capture_exists: false },
  ...
  { page_name: 'Operator Trial Page', page_url: '/operator-trial', page_status: 'Not Built', form_connected: false, thank_you_page_exists: false, crm_capture_exists: false, operator_notification_exists: false, email_notification_exists: false, retargeting_capture_exists: false },
  { page_name: 'Operator Referral Page', page_url: '/operator-referral', page_status: 'Not Built', form_connected: false, thank_you_page_exists: false, crm_capture_exists: false, operator_notification_exists: false, email_notification_exists: false, retargeting_capture_exists: false },
