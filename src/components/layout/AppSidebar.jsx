...
export const ALL_NAV_ITEMS = [
  ...
  { page: 'SaleStatistics',         label: 'Statistics',          icon: BarChart3,       group: 'Estate Sales' },
  { page: 'PrintSigns',             label: 'Print Signs',         icon: Megaphone,       group: 'Estate Sales' },
  { page: 'SaleExport',             label: 'Export',              icon: FileText,        group: 'Estate Sales' },
  ...
  { page: 'AdminLeads',             label: 'Leads',               icon: Award,           group: 'Admin' },
