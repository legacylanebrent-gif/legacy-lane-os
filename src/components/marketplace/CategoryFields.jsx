...
const CATEGORY_FIELDS = {
  ...
  jewelry: [
    { key: 'metal_type', label: 'Metal Type', type: 'select', options: ['Gold', 'Silver', 'Platinum', 'Rose Gold', 'Gold-Filled', 'Gold-Plated', 'Stainless Steel', 'Costume', 'Other'] },
    { key: 'karat', label: 'Karat (if applicable)', type: 'select', options: ['10K', '14K', '18K', '24K', 'Sterling Silver', 'N/A'] },
    { key: 'gemstone', label: 'Gemstone', type: 'text' },
    { key: 'gemstone_weight', label: 'Gemstone Weight (carats)', type: 'text' },
    { key: 'metal_weight', label: 'Metal Weight (grams)', type: 'text' },
    { key: 'brand_designer', label: 'Brand / Designer', type: 'text' },
    { key: 'is_authenticated', label: 'Authenticated / Tested', type: 'checkbox' },
    { key: 'has_appraisal', label: 'Includes Appraisal', type: 'checkbox' },
    { key: 'has_box', label: 'Includes Original Box', type: 'checkbox' },
  ],
  gold_silver_jewelry: [
    { key: 'metal_type', label: 'Metal Type', type: 'select', options: ['Gold', 'Silver', 'Platinum', 'Rose Gold', 'Mixed'] },
    { key: 'karat', label: 'Karat / Purity', type: 'select', options: ['10K', '14K', '18K', '22K', '24K', '999 Fine Silver', 'Sterling Silver (.925)', 'Other'] },
    { key: 'weight_grams', label: 'Weight (grams)', type: 'text' },
    { key: 'gemstone', label: 'Gemstone (if any)', type: 'text' },
    { key: 'is_tested', label: 'Metal Tested / Verified', type: 'checkbox' },
    { key: 'has_hallmarks', label: 'Has Hallmarks / Stamps', type: 'checkbox' },
    { key: 'has_appraisal', label: 'Includes Appraisal', type: 'checkbox' },
  ],
  collectibles: [
