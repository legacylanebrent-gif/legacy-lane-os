...
Deno.serve(async (req) => {
  try {
    ...
    // Scrape first 2 companies as sample
    const sampleCompanies = [];
    const sampleLinks = uniqueCompanyLinks.slice(0, 2);
